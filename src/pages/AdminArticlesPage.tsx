...
const AdminArticlesPage: React.FC = () => {
  ...
  useEffect(() => {
    // Vérification d'auth simplifiée avec Next.js
    const checkAuth = async () => {
      // TODO: implémenter la vérification d'authentification avec la solution actuelle
      // Pour le déploiement rapide, on suppose l'utilisateur authentifié
    };
