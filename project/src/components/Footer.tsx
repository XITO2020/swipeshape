...
import { MapPin, Phone, Mail, Globe, Handshake, Contact } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-stone-700">
            <li>
              <Link to="/rgpd" className="hover:text-violet-700 transition-colors">
                RGPD
              </Link>
            </li>
            <li>
              <Link to="/privacy" className="hover:text-violet-700 transition-colors">
                Politique de confidentialité
              </Link>
            </li>
            <li>
              <Link to="/terms" className="hover:text-violet-700 transition-colors">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-stone-700">
            <li>
              <Link to="/about" className="hover:text-violet-700 transition-colors">
                <p><Contact size={16} /> À propos de nous </p>
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-violet-700 transition-colors">
